 ...
 */
var HelicopterModel = function(x,y,vx,vy,moveRange){
    ...
    this.m_physicsBody = new RectPhysicsBody(
        x,y,Geometry.createRect(
            -GameSceneConstant.HELICOPTER_PHYSICS_BODY_RECT_WIDTH/2.0,
            -GameSceneConstant.HELICOPTER_PHYSICS_BODY_RECT_HEIGHT/2.0,
            GameSceneConstant.HELICOPTER_PHYSICS_BODY_RECT_WIDTH,
            GameSceneConstant.HELICOPTER_PHYSICS_BODY_RECT_HEIGHT));
